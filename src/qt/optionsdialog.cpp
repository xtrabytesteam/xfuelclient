    ...
    fProxyIpValid(true)
{
    ...
    ui->unit->setModel(new XFuelUnits(this));
...
void OptionsDialog::setMapper()
{
    ...
    mapper->addMapping(ui->xfuelAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::showRestartWarning_Proxy()
{
    ...
    {
        QMessageBox::warning(this, tr("Warning"), tr("This setting will take effect after restarting XFuel."), QMessageBox::Ok);
