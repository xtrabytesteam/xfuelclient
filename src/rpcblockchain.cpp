...
Object blockToJSON(const CBlock& block, const CBlockIndex* blockindex)
{
    ...
    result.push_back(Pair("minerid", (boost::uint64_t)block.MinerID));
    result.push_back(Pair("signature", HexStr(block.BlockSignature.begin(), block.BlockSignature.end()).c_str()));
