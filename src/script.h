...
#ifndef H_XFUEL_SCRIPT
#define H_XFUEL_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CXFuelAddress
 */
...
public:
    ...
    // Pre-version-0.6, XFuel always counted CHECKMULTISIGs
